...
//        CampusUser user1 = new CampusUser("mail", "psw", 40000);
...
//        CampusUser user1 = new CampusUser("userEmail2", "psw2", 40000);
//        var order = new Order(restaurant, UUID.randomUUID(), user1);
...
//        CampusUser user1 = new CampusUser("userEmail3", "psw3", 40000);
//        var order = new Order(restaurant, UUID.randomUUID(), user1);
//        for (MenuItem item : restaurant.getMenu().getItems().subList(0, n-1)) {
//            order.addItem(item);
//        }
