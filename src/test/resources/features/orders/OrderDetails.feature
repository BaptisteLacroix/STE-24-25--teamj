Feature: Order Details
  ...
  Background:
    Given the restaurant service manager configured the following restaurants:
      | Name             | Menu Items                                           | Opening Time      | Closing Time      | Delivery Locations       |
      | Le Petit Nice    | Salade Nicoise, Bouillabaisse, Tarte Tatin            | 2021-01-01 10:00  | 2021-01-01 22:00  | Campus Lane, Campus Street |
      | Le Petit Jardin  | Salade de chèvre chaud, Magret de canard, Crème brûlée| 2021-01-01 11:00  | 2021-01-01 23:00  | Campus Avenue, Campus Road |
      | Le Petit Chateau | Escargots, Coq au vin, Mousse au chocolat             | 2021-01-01 09:00  | 2021-01-01 21:00  | Campus Boulevard, Campus Plaza |
  ...
  Scenario: Registered user selects a restaurant and tries to select a delivery location that is not recorded in the restaurant
    ...
    And [OrderDetails]the user receives an error message "123 Campus Lane is not a valid delivery location for Le Petit Nice"
