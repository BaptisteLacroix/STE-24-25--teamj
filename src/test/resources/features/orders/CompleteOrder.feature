Feature: 3 users are doing a complete group order, specifying delivery location and time, choosing restaurant and items.
  ...
  Scenario: The first user creates a group order with delivery location and time, and adds items to his order
    ...
    And He searches restaurants that are open and can prepare items in time and should see:
      | Name             |
      | Le Petit Nice    |
      | Le Petit Jardin  |
      | La Table Royale  |
    And He selects the restaurant "Le Petit Nice" and sees the items compatible with the group order delivery time preparation:
      | Menu Item      |
      | Salade Nicoise |
      | Bouillabaisse  |
    ...
    And He searches restaurants that are open and can prepare items in time and should see:
      ...
      | Le Petit Jardin  |
      | La Table Royale  |
    And He selects the restaurant "Le Petit Jardin" and sees the items compatible with the group order delivery time preparation:
      | Menu Item              |
