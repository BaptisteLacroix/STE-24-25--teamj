# Feature: Any member of a group order can validate the group order at the end of its individual order and if needed specify a delivery time
#
#   Background:
...
#
#   Scenario: The creator of a group order add its order to the group order and another user joins the group order and validates it
#     Given [ValidateGroupOrder]the "2ed64a86-d499-4a9c-a0a1-9aba06297348" user is registered
